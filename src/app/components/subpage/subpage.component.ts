...
export class SubpageComponent implements OnInit {
  public appTitle:string='galaxia'; /* creamos variable string y le asignamos el contenido galaxia, el cual la pipe va a modificar*/
  @Input ('size') size: number = 10; /* @decorador ('variable') variable:tipo = datodefaultparacambiar.*/
  @ViewChild('box') box;
